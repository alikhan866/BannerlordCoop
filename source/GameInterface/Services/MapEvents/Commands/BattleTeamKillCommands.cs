...
internal class BattleTeamKillCommands
{
    ...
    /// <remarks>
    /// For callers that have no attacker of their own to name. It routes through the two-argument overload
    /// rather than rebuilding the blow, so the attribution fix below applies to them as well instead of
    /// quietly reverting to a self-inflicted kill.
    /// </remarks>

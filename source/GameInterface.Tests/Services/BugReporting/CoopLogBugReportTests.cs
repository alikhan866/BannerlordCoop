...
public class CoopLogBugReportTests : IDisposable
{
    ...
    public void ShouldPublishGameSaved_UnrecognisedDriver_StillWritesTheSidecar()
    {
        ...
        // The one the join transfer uses, which must stay excluded. The bug reporter's
        // CoopFileInMemSaveDriver was removed upstream when bug-report saves became persistent.
